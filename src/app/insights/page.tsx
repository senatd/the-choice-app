          ...
          <Card className="bg-white/80 border border-[color:var(--sage-soft)]/50">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="relative h-10 w-full overflow-hidden rounded-full bg-[#EDE7DA]">
                ...
                />
                <div
                  className="absolute right-0 top-0 h-full rounded-full bg-gradient-to-l from-[#E8C361] to-[#F5E0A5] transition-all duration-700"
              ...
              <div className="flex justify-between text-xs text-[#6F685E]">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Star className="h-3 w-3 text-[#E8C361] fill-current" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {!tagInsights.hasTagData ? (
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <Card className="bg-white/80 border border-[color:var(--sage-soft)]/50">
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-2 text-sm text-[#3F3A33]">
                    <Star className="h-3.5 w-3.5 text-[#E8C361] fill-current" />
                    What drives your No
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  {tagInsights.noTags.length === 0 ? (
                    ...
                    <div key={tag} className="space-y-1">
                      ...
                      <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#E6DFD2]">
                        <div
                          className="h-full rounded-full bg-gradient-to-r from-[#E8C361] to-[#F5E0A5] transition-all duration-500"
                          style={{ width: `${Math.max(6, percent)}%` }}
                        />
                      </div>
                    </div>
